...
async def pmpermit_on(event):
    ...
    if input_str == "تشغيل":
        if gvarstatus("pmpermit") is None:
            ...
            await edit_delete(event, "**🝳 ⦙   تـم تـفـعـيـل امـ مال امك ر الـحـمـايـة لـحـسـابـك بـنـجـاح  ✅**")
        else:
            await edit_delete(event, "**🝳 ⦙  امـر الـحـمـايـة بـالـفـ مال امك عـل مُـمَـكـن لـحـسـابـك  🌿**")
